...
export const DASHBOARD_ONBOARDING_STEPS = [
  {
    ...
    description: "This dashboard gives a quick operational and KPI readiness overview.",
    selector: '[data-onboarding-target="dashboard-header"]',
  },
  {
    title: "Your KPIs",
    description: "These KPI cards are placeholders until data sources are fully configured.",
    selector: '[data-onboarding-target="kpi-summary"]',
  },
  {
    title: "System Status",
    description: "Track adapter, intents, and database connectivity from one view.",
    selector: '[data-onboarding-target="system-status"]',
  },
  {
    title: "Settings & Configuration",
    description: "Use Settings to configure platform, metrics, intents, and emission factors.",
...
export const KPI_SUMMARY_ITEMS: KpiSummaryItem[] = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor">
        <path d="M13 2L6 13h5l-1 9 8-12h-5l0-8z" strokeWidth="2" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor">
        <path d="M4 7h16M7 7v12m10-12v12M6 19h12" strokeWidth="2" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor">
        <path d="M4 15a4 4 0 014-4h7a4 4 0 110 8H8a4 4 0 01-4-4z" strokeWidth="2" />
...
export function buildDashboardStatusCards(status: SystemStatusResponse): DashboardStatusCard[] {
  ...
  return [
    ...
    },
    {
      ...
      tone: "info",
      helpText: "Shows the currently active platform connector AVAROS is using.",
    },
    {
      label: "Platform Type",
      ...
      icon: (
        <svg className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <path d="M12 3l8 4.5v9L12 21l-8-4.5v-9L12 3z" strokeWidth="2" strokeLinejoin="round" />
        </svg>
      ),
      tone: "info",
    ...
    },
    {
      ...
      icon: (
        <svg className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <path d="M5 6h14M5 12h14M5 18h9" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
      tone: "info",
    ...
    },
    {
      ...
      tone: "info",
      helpText: "Confirms whether AVAROS can persist/read configuration and runtime data.",
    },
    {
      label: "Version",
