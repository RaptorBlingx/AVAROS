...
| `WAKEWORD_DETECTION_COOLDOWN_SECONDS` | `1.2` | Suppresses duplicate detection events from the same spoken wake phrase. Useful when `WAKEWORD_CONFIRMATION_FRAMES=1` for demo responsiveness. |
